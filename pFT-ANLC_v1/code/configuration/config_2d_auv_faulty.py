...
AUV with 3 thrusters affected by actuator faults.
...
def set_params():
    ...
    campaign_params = {
        ...
        'campaign_run': 4,      # number of the run:
        ...
        'system_name': "2d_auv_faulty",  # name of the systems to be controlled (only used in the statistics file, pick any name).
