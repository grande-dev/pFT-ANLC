...
The main file to run a simulation campaign for the training of a 3-dimensional 
system with 4 actuators affected by faults. 
...
from utilities.models import Template_model3D_Faulty as UsedModel
import configuration.config_3d_faulty_template as config_file
import closed_loop_testing.cl_3d_template as cl
import systems_dynamics.dynamics_3d_faulty_template as dynamic_sys
