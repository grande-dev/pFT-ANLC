...
AUV with 3 thrusters system affected by actuator faults. 

This scripts executes recursive callbacks to the CEGIS training file, in turn invoking
the postprocessing and generating the final statistics.
...
from utilities.models import AUV2D_Faulty as UsedModel
import configuration.config_2d_auv_faulty as config_file
import closed_loop_testing.cl_2d_auv_faulty as cl
import systems_dynamics.dynamics_2d_auv_faulty as dynamic_sys
...
saving_stat.info_faults(parameters, final_dir_campaign)
